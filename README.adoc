...
https://coveralls.io/github/yarmiganosca/dependency_bundle?branch=master[image:https://coveralls.io/repos/github/yarmiganosca/dependency_bundle/badge.svg?branch=master[Test Coverage]]
